...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //example of inserting new data to the DB
    func populateDatabase(){
        ...
        do{
            ...
            print("failed saved to DB");
        }
    }
    
    //eample of updating existing data in DB
    ...
    //example of reading existing data from DB
    func readDataFromDB(){
        let fetchRequest = NSFetchRequest(entityName: entityName);
        fetchRequest.predicate = NSPredicate(format: "age > %@", 30 as NSNumber);
    ...
    //example of deleting existing data from DB
    func deletFromDB(){
        let fetchRequest = NSFetchRequest(entityName: entityName);
        do{
            let persons = try managedObjectContext.executeFetchRequest(fetchRequest) as! [Person];
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.example.Learning_Core_Data" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Learning_Core_Data", withExtension: "momd")!
